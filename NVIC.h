...
#define NVIC_global_enable_interrupts __enable_irq() // This call an instruction in assembler
#define NVIC_disable_interrupts __disable_irq()      // This call an instruction in assembler
 ...
 */
void NVIC_disable_interrupt_and_prioriry(interrupt_t interrupt_number);
